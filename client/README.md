...
* unctionality: Users can easily search for courses, lessons, and resources using the built-in search feature. This makes it convenient to find relevant 
  content quickly.
...
1. Clone the repository to your local machine.
    ```sh
    git clone https://github.com/Key-runnnnnnn/Study-Notion.git
    ```
